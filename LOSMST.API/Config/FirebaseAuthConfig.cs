...
namespace LOSMST.API.Config
{
    public static class FirebaseAuthConfig
    {
        public static void ConfigFirebaseAuth(this IServiceCollection services)
        {
            Environment.SetEnvironmentVariable("GOOGLE_APPLICATION_CREDENTIALS", "capstone-project-edc2a-firebase-adminsdk-w5qk4-37e986decb.json");
